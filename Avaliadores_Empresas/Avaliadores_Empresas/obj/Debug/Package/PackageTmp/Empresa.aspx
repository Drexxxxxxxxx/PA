...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="stylesheets/style_empresas.css" />
...
<body>
        ...
        <div>
            <section>
              ...
              <div class="DivBtns_In">
                <div class="row">
                    <div class="col-sm-12" style="position: absolute; z-index: 9999;">
    ...
    <script src="https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/markerclusterer.js">
        ...
        <asp:Image ID="Image1" runat="server" Style="z-index: 1" Height="100%" ImageUrl="imagemfundo.jpg" Width="100%" />
